...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  duties: 'duty.md',
  dutyRunner: 'duty.md',
  dutyTriggers: 'duty.md',
  dutyVerifiers: 'duty.md',
  e2b: 'subprocess.md',
  fs: 'filesystem.md',
  goals: 'goal.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CreateDutyRequest: 'duty.md',
  DutyClaim: 'duty.md',
  DutyErrorCode: 'duty.md',
  DutyId: 'duty.md',
  DutyLifecycle: 'duty.md',
  DutyPauseReason: 'duty.md',
  DutyRun: 'duty.md',
  DutyRunCause: 'duty.md',
  DutyRunId: 'duty.md',
  DutyRunStatus: 'duty.md',
  DutySkipReason: 'duty.md',
  DutySpec: 'duty.md',
  DutyState: 'duty.md',
  DutyTriggerEvent: 'duty.md',
  DutyVersion: 'duty.md',
  DutyView: 'duty.md',
  EditDutyRequest: 'duty.md',
  HumanRequest: 'duty.md',
  HumanRequestId: 'duty.md',
  HumanRequestReason: 'duty.md',
  DutyTriggerObservation: 'duty.md',
  DutyTriggerProvider: 'duty.md',
  DutyVerificationEvidence: 'duty.md',
  DutyVerificationRequest: 'duty.md',
  DutyVerdict: 'duty.md',
  DutyVerifier: 'duty.md',
