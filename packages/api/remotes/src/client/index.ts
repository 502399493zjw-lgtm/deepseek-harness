...
import dutiesRemote from '@deepseek-ai/dsh-duty/remote'
...
export type {} from '@deepseek-ai/dsh-duty/remote'
...
export type {
  CreateDutyRequest, DutyId, DutyLifecycle, DutyPauseReason, DutyRun, DutyState,
  DutyTriggerEvent, DutyVersion, DutyView, EditDutyRequest, HumanRequest,
  HumanRequestId,
} from '@deepseek-ai/dsh-duty/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, dutiesRemote,
    ]) {
