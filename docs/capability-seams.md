...
| `ctx.openAICodex` | `bundle` | `dsh-codex_shared_pool` | - | - | - | Owns one credential and preference state for the bundle's model adapter, browser routes, quota child, and terminal command front doors. |
