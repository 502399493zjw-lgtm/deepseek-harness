...
Depends on: [`CodexQuotaConfig`](#deepseek-aidsh-host-codex-quota)

Source: [`packages/bundle/dsh-codex_shared_pool/src/index.ts:110`](../packages/bundle/dsh-codex_shared_pool/src/index.ts)
...
Source: [`packages/host/codex-quota/src/index.ts:22`](../packages/host/codex-quota/src/index.ts)
